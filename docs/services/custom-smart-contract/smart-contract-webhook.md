...
```js title="Sample Result"
{
    ...
    "pagination": {
        "current_page": 1,
        "first_page_url": "http://localhost/api/projects/test-project/versions/1-v101/webhooks?page=1",
        "last_page": 1,
        "last_page_url": "http://localhost/api/projects/test-project/versions/1-v101/webhooks?page=1",
        "next_page_url": null,
        "per_page": 10,
        "prev_page_url": null,
        "total": 3
