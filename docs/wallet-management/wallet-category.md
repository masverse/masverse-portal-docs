...
```
{{base_url}}/api/wallet/wallet-category
```
#### HEADERS
...
```
{{base_url}}/api/wallet/wallet-category/{id}
```
#### HEADERS
...
```
{{base_url}}/api/wallet/activate-wallet-category/{id}
```
#### HEADERS
...
```
{{base_url}}/api/wallet/deactivate-wallet-category/{id}
```
#### HEADERS
