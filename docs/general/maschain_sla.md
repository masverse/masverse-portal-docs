...
> **This is a technical summary, not the binding contract.** The legally binding
> SLA forms part of your Master Terms (master services / subscription agreement,
> order forms, statements of work, and schedules). Where this summary and the
> signed SLA or Master Terms conflict, the signed documents prevail. Capitalised
> terms have the meanings given in the SLA and Master Terms.
